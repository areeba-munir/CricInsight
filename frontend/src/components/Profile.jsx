...
const ProfileEdit = () => {
  ...
  useEffect(() => {
    ...
    if (userEmail) {
      axios
        .get(`https://cricinsight-backend.vercel.app/api/user?email=${userEmail}`)
        .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("https://cricinsight-backend.vercel.app/api/user/updateUser", updatedData)
      .then((response) => {
  ...
  const handleDelete = () => {
    setOpen(false);
    axios
      .delete(`https://cricinsight-backend.vercel.app/api/user/deleteUser?email=${profileData.email}`)
      .then((response) => {
